import { CoreWindow, Graphics, ScreenSprite, Stage, Utils, WindowLayer } from 'rpg_core';
...
export default class Scene_Base extends Stage {
    ...
    protected _imageReservationId: number = Utils.generateRuntimeId();
     ...
     * @memberof Scene_Base
     */
    startFadeOut(duration: number = 30, white: boolean = false) {
        this.createFadeSprite(white);
        this._fadeSign = -1;
