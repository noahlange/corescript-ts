...
export default class Utils {
    ...
    static isNwjs(): boolean {
        return !this.isElectron() && typeof (window as any)['require'] === 'function' && typeof (window as any)['process'] === 'object';
    };

    static isElectron(): boolean {
        let processOne = (window as any).Process;
        let processTwo = (window as any).process;
        if (
